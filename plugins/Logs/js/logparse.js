...
// parseLogs takes a sen directory and an array of log name filters to match,
// and returns a concatenated, sorted log string composed of every log that
// matched inside the sen directory.
...
export const updateLogFilters = (state, size, filters) =>
	state.set('logFilters', filters)
	     .set('logSize', size)
	     .set('logText', parseLogs(sentientdir, size, filters))
