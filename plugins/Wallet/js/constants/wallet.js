...
export const INIT_NEW_WALLET = 'INIT_NEW_WALLET'
...
export const SHOW_SEND_VIEW = 'SHOW_SEND_VIEW'
export const CLOSE_SEND_VIEW = 'CLOSE_SEND_VIEW'
...
export const HIDE_ALL_VIEWS = 'HIDE_ALL_VIEWS'
export const SHOW_TRANSACTION_LIST_VIEW = 'SHOW_TRANSACTION_LIST_VIEW'
export const HIDE_TRANSACTION_LIST_VIEW = 'HIDE_TRANSACTION_LIST_VIEW'
export const SHOW_RECEIVE_VIEW = 'SHOW_RECEIVE_VIEW'
export const HIDE_RECEIVE_VIEW = 'HIDE_RECEIVE_VIEW'
...
export const SHOW_INIT_WALLET_VIEW = 'SHOW_INIT_WALLET_VIEW'
export const HIDE_INIT_WALLET_VIEW = 'HIDE_INIT_WALLET_VIEW'
export const SHOW_INIT_BACKUP_WALLET_VIEW = 'SHOW_INIT_BACKUP_WALLET_VIEW'
export const HIDE_INIT_BACKUP_WALLET_VIEW = 'HIDE_INIT_BACKUP_WALLET_VIEW'
export const SHOW_INITIALIZING_SEED_VIEW = 'SHOW_INITIALIZING_SEED_VIEW'
export const HIDE_INITIALIZING_SEED_VIEW = 'HIDE_INITIALIZING_SEED_VIEW'
export const SET_PASSWORD = 'SET_PASSWORD'
export const SET_PASSWORD_CONFIRMATION = 'SET_PASSWORD_CONFIRMATION'
export const SET_GENERATE_NEW_SEED = 'SET_GENERATE_NEW_SEED'
export const SET_SEED = 'SET_SEED'
export const SET_INIT_WALLET_ERROR = 'SET_INIT_WALLET_ERROR'
export const SET_CONFIRM_SEED_BACKUP = 'SET_CONFIRM_SEED_BACKUP'
